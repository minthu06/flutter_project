...
import 'package:flutter_application_1/defination_page.dart';
...
import 'package:flutter_application_1/screen/news_page.dart';
import 'package:flutter_application_1/stack.dart';
import 'package:provider/provider.dart';

void main() {
  runApp(MultiProvider(
    providers: [ChangeNotifierProvider(create: (_) => NewsApi())],
    child: MaterialApp(
      home: ((NewsHomePage())),
    ),
  ));
